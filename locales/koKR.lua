...
["Filters"] = "필터",
["Spell Filters"] = "주문 필터",
["Create and manage reusable spell ID filter lists"] = "재사용 가능한 주문 ID 필터 목록 생성 및 관리",
...
["Add Spell"] = "주문 추가",
["Search by spell name or enter a spell ID"] = "주문 이름으로 검색하거나 주문 ID를 입력하세요",
["Add"] = "추가",
["Add this spell to the filter list"] = "이 주문을 필터 목록에 추가",
["Spells"] = "주문",
["Remove"] = "제거",
["Remove this spell from the filter list"] = "이 주문을 필터 목록에서 제거",
