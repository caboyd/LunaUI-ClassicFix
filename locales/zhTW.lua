...
["Filters"] = "篩選器",
["Spell Filters"] = "法術篩選器",
["Create and manage reusable spell ID filter lists"] = "建立和管理可重複使用的法術ID篩選列表",
...
["Add Spell"] = "新增法術",
["Search by spell name or enter a spell ID"] = "按法術名稱搜尋或輸入法術ID",
["Add"] = "新增",
["Add this spell to the filter list"] = "將此法術新增至篩選列表",
["Spells"] = "法術",
["Remove"] = "移除",
["Remove this spell from the filter list"] = "從篩選列表中移除此法術",
