...
["Filters"] = "过滤器",
["Spell Filters"] = "法术过滤器",
["Create and manage reusable spell ID filter lists"] = "创建和管理可重复使用的法术ID过滤列表",
...
["Add Spell"] = "添加法术",
["Search by spell name or enter a spell ID"] = "按法术名称搜索或输入法术ID",
["Add"] = "添加",
["Add this spell to the filter list"] = "将此法术添加到过滤列表",
["Spells"] = "法术",
["Remove"] = "移除",
["Remove this spell from the filter list"] = "从过滤列表中移除此法术",
